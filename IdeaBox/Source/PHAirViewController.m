...
#define kSessionWidth   200

#define kLeftViewTransX      -50
#define kLeftViewRotate      -10
#define kAirImageViewRotate  -18
#define kRightViewTransX     140
...
- (void)reloadData
{
    ...
    for (int i = 0; i < session; i ++) {
        ...
        int firstTop = (sessionView.containView.frame.size.height - [rowsOfSession[i] intValue] * heightAirMenuRow)/3;
